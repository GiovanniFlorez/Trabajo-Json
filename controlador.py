class Controlador:
    ...
    def procesar_opcion(self, opcion_str):
        try:
            ...
            self._vista.mostrar_error("Error", "Opción no válida.")
            self._vista.mostrar_menu(self.procesar_opcion)
            return
    ...
    def crear(self):
        def volver(datos):
            if datos:
                ...
                self._vista.mostrar_exito("Éxito", "Registro creado exitosamente.")
    ...
    def procesar_actualizar(self, indice_str, callback_volver):
        try:
            ...
            self._vista.mostrar_error("Error", "Índice no válido.")
            self._vista.mostrar_menu(self.procesar_opcion)
            return
    ...
    def procesar_eliminar(self, indice_str, callback_volver):
        ...
        self._vista.mostrar_exito("Éxito", "Registro eliminado exitosamente.")
        self._vista.mostrar_datos(self._modelo.leer())
        callback_volver()
